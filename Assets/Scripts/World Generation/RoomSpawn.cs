    ...
    private void FillRoom()
    {
        switch (type)
        {
            ...
            case Room.RoomType.Treasure:
                completed = true;
                open = true;
                Instantiate(_chest, transform.position + new Vector3(size.x / 2f, size.y / 2f, 0f),
                    Quaternion.identity);
                break;
            case Room.RoomType.Shop:
                completed = true;
                open = true;
                Instantiate(_shop, transform.position + new Vector3(size.x / 2f, size.y / 2f + 1, 0f),
                    Quaternion.identity);
                Instantiate(_heartShop, transform.position + new Vector3(size.x / 2f - 2, size.y / 2f - 1, 0f),
                    Quaternion.identity);
                Instantiate(_heartShop, transform.position + new Vector3(size.x / 2f + 2, size.y / 2f - 1, 0f),
                    Quaternion.identity);
                break;
            ...
            case Room.RoomType.Boss:
                Instantiate(_stairs, transform.position + new Vector3(size.x / 2f, size.y / 2f, 0f),
                    Quaternion.identity);
                break;
            default:
